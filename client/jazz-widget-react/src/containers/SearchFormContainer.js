        ...
        return (
            ...
            <Form>
                <Form.Group>
                    <Row>
                        <Col xs={6} md={4}>
                            <Form.Control value={rowSearchTerm} onChange={onRowChange} placeholder={rowPlaceholder}/>
                        </Col>
                        <Col xs={6} md={4}>
                            <Form.Control value={columnSearchTerm} onChange={onColumnChange} placeholder={columnPlaceholder}/>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={6} md={4}>
